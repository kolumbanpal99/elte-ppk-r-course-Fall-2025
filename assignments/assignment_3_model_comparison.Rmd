...
# there is a significant difference between this 2 models
# Compared to the simple model which includes age and sex the more complex model explains more variance (36-33%) compared to (8,4-7,2%)
...
# During the test process we dropped one saliva measure because of multicollinearity (cortisol serum and saliva has r = 0.91)
